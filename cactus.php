        ...
        <div>
             <a href="index.php"><h1>JPJ MarketPlace</h1></a>
              <a href="/">Home</a>
                ...
                ?>
                <?php
                $result = mysqli_query($db,"SELECT * FROM products WHERE category = 'cactus'");
                ...
                <?php echo $status; echo $_SESSION["shopping_cart"].[0]; echo $_SESSION["shopping_cart"].[1]; echo $_SESSION["shopping_cart"].[2]  ?>
                </div>
</body>
</html>